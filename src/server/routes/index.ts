...
router.post(
  '/passwordReset',
  UsuarioController.passwordResetValidation,
  UsuarioController.passwordResetRequest
)
router.post(
  '/newPassword/:chave',
  UsuarioController.newPasswordValidation,
  UsuarioController.newPasswordRequest
)
router.post(
  '/resendEmailConfirmation',
  UsuarioController.resendEmailConfirmationValidation,
  UsuarioController.resendEmailConfirmation
)
router.get(
  '/validateEmail/:chave',
  UsuarioController.validateEmailValidation,
...
router.delete(
  '/produtos/:id',
  ensureAuthenticated,
  ProdutoController.deleteByIdValidation,
  ProdutoController.deleteById
)
router.get(
  '/produtos/:id',
  ensureAuthenticated,
  ProdutoController.getByIdValidation,
